...
We follow below diagram from the experimental schematic link. Here we use digital pin 10. We connect LED to a 330 ohm resistor to avoid high current damaging the LED.
